 ...
 * 
 */
@WebServiceClient(name = "AccountServiceService", targetNamespace = "http://innerServices.server.bsr/", wsdlLocation = "http://localhost:8080/internalAccounts?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ACCOUNTSERVICESERVICE_QNAME = new QName("http://innerServices.server.bsr/", "AccountServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/internalAccounts?wsdl");
    ...
    public AccountService getAccountServicePort() {
        return super.getPort(new QName("http://innerServices.server.bsr/", "AccountServicePort"), AccountService.class);
    }
    ...
    public AccountService getAccountServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://innerServices.server.bsr/", "AccountServicePort"), AccountService.class, features);
    }
