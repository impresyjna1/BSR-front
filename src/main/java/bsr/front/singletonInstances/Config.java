...
public abstract class Config {
    ...
    public static final String ACCOUNT_SERVICE_URL = "http://localhost" + SERVER_ADDR + ":"  + SOAP_PORT + "/bankAccounts?wsdl";
    public static final String OPERATIONS_SERVICE_URL = "http://localhost" + SERVER_ADDR + ":"  + SOAP_PORT + "/bankOperations?wsdl";
}
